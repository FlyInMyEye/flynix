...

{
  home-manager.sharedModules = [
    ({ ... }: {
      ...
      # Increase scan timeout to prevent warnings in large directories
      scan_timeout = 100;  # milliseconds (default is 30)
      command_timeout = 1000;  # milliseconds for external commands
